export const CondoLocations = [
    // HIGHLAND -->done
    {
        ...
        type: ['Transit-Oriented', 'Condominium'],
    ...
    // COVENT GARDEN
    {
        ...
        type: ['Transit-Oriented', 'Condominium'],
        logo: '/covent/covent-logo.png',
        description: "Empire East has finally unveiled another luxury property designed to be one's own urban sanctuary in the middle of the city. Inspired by the ebullient charm of London's renowned tourist attraction, its combined grace and  splendor has now arrived within Sta. Mesa in the City of Manila! Welcome to your very own Covent Garden!",
        // price: 4100000,
        price: 10000,
        img: [
            "/covent-garden.jpg",
    ...
    // THE ROCHESTER
    {
        ...
        location: 'Pasig City',
        type: ['Urban Resort'],
        logo: '/rochester/the-rochester-logo.png', 
        description: "Upon entering the gates of The Rochester, one is instantly mesmerized at its exuding Asian-Contemporary charm that beautifully blends nature elements with a backdrop of earth tone palettes. Its aesthetic warmth emanates a prevailing sense of balance, openness and gentleness that are perfect for a modern day household.  Windows are clear and big to facilitate better inflow of light. ",
        // price: 2800000,
        price: 12000,
        img: [
            "/the-rochester.jpg",
    ...
    // SAN LORENZO PLACE
    {
        ...
        type: ['Transit-Oriented', 'Urban Resort'],
        logo: '/slp/slp-logo.png',
        description: "Only the classy, the elegant and the powerful come here at San Lorenzo Place. Your  newest home that brings you right within the elite taste of the Makati Central Business District.  Wake up next to your workplace or do business at  your own convenience as Metro Manila's  financial workplace come waiting for you just right outside your window.",
        price: 30000,
        img: [
    ...
    // MANGO TREE RESIDENCE
    {
        ...
        type: ['Condominium'],
        logo: '/mango-tree/mango-tree-logo.png',
        description: "Geographically in the heart of Metro Manila, the historic and progressive city of San Juan is gifted with premium accessibility to major business districts and lifestyle destinations, making it one of the most sought-after addresses for luxury living. In one of San Juan City’s quiet neighborhoods, at the corner of M. Paterno and Ledesma Streets, rises the most exciting community in this side of the metropolis– the Mango Tree Residences by topnotch real estate innovator Empire East.",
        // price: 4800000,
        price: 12500,
        img: [
