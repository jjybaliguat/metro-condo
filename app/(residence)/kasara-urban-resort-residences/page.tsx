    ...
    <div className="relative flex flex-col gap-0">
        <div className="relative flex md:flex-row flex-col w-full h-fit">
            <div className="relative md:h-[100vh] h-[300px] md:w-[65%] w-full">
                <img src={CondoLocations[2].img[0]} 
            ...
            w-full bg-primary flex flex-col gap-5 flex-center p-10 text-white">
                <h1 className='md:text-[3rem] text-[2rem] font-bold text-center'>{CondoLocations[2].name}</h1>
                <h1 className='md:text-[1.5rem] text-[1rem]'>{CondoLocations[2].description}</h1>
            </div>
        </div>
    </div>
    </PageWrapper>
